...
add_action( 'wp_enqueue_scripts', 'understrap__scripts' );
function understrap__scripts()
{
	wp_enqueue_script('quilo_javascript',			get_template_directory_uri() . '/js/quilo.js');
}
